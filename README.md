...
(proyecto `moaltxlpdysqeuujccis`, región `sa-east-1`).
...
- `NEXT_PUBLIC_SUPABASE_URL` — `https://moaltxlpdysqeuujccis.supabase.co`
...
[Auth → URL Configuration](https://supabase.com/dashboard/project/moaltxlpdysqeuujccis/auth/url-configuration):
